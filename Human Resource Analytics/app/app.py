...
completion = openai.ChatCompletion.create(
  model="gpt-3.5-turbo",
  messages=[
        {"role": "user", "content": f"Essa tabela possui as métricas de um departamento de recursos humanos {dataset}. O modelo de predição gera um novo dataset {data_teste} onde a coluna prediction_label mostra o resultado. Se o resultado da coluna prediction_label for 0, o funcionário fica na empresa. Se o resultado da coluna prediction_label for 1, o funcionário deve sair a empresa. A coluna prediction_score mostra a probabilidade disso acontecer. Me informe 1 insight sobre os dados do dataset {data_teste} gerado pelo modelo de predição."},
    ]
)
